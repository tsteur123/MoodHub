...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        <div class="section group">
            ...
            <form class="" action="C:/xampp/htdocs/MoodHub/index.php" method="post">
        ...
        <div class="section group">
            ...
            <div class="col span_1_of_3 matchheight">
            <h1>Profiel</h1>
            <br /><img src="img/vraagteken.jpg" alt="" class="vraagteken">
            <br />naam:
            <br />leerlingnummer: <?php print_r($_SESSION['username']); ?>
            <br />email: t.steur@student.alfa-college.nl
            </div>
        </div>
        <div class="section group">
            <div class="col span_2_of_2">
